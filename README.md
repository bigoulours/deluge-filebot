A fork of [linuxserver/docker-deluge](https://github.com/linuxserver/docker-deluge) with [filebot v4.7.9](https://sourceforge.net/projects/filebot/files/filebot/FileBot_4.7.9/) (last open source version).
